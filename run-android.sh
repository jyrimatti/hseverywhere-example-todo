...
nix-shell -p jre8 which nodejs-10_x --run "cd rnproject; ADB_INSTALL_TIMEOUT=16 ANDROID_HOME=$DIR/rnproject/android/androidsdk/libexec ./node_modules/.bin/react-native run-android --no-packager"
