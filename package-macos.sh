...
nix-shell -p nodejs-10_x --run "(cd rnproject/macos && PLATFORM=macos /usr/bin/xcodebuild -xcconfig $DIR/rnproject/.xcconfig -scheme rnproject -configuration Release -target rnproject archive -archivePath $DIR/dist/rnproject.xcarchive)"
